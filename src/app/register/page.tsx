...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Redirect to dashboard on success (cookies set by API)
        ...
        <div className="min-h-screen flex items-center justify-center bg-dark-blue px-4">
            <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-gray-600 mt-2">Create your account</h2>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-teal text-white font-bold py-3 rounded-lg hover:bg-[#008f7a] transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 mt-2"
                    >
                ...
                <div className="mt-8 text-center text-sm text-gray-500">
                    <p>Already have an account? <Link href="/login" className="text-teal hover:underline font-bold">Sign In</Link></p>
                </div>
            </div>
        </div>
    );
