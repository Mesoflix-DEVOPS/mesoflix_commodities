...
const OfferPopup = () => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-dark-blue/60 backdrop-blur-sm animate-in fade-in duration-500">
            <div className="relative w-full max-w-xl bg-white dark:bg-[#0A1622] rounded-[2rem] shadow-[0_0_50px_rgba(0,0,0,0.3)] border border-gold/30 overflow-hidden animate-in zoom-in-95 duration-500">
                {/* Close Button */}
                <button
                    onClick={dismiss}
                ...
                {/* Top Banner */}
                <div className="h-32 bg-golden-gradient relative flex items-center justify-center overflow-hidden">
                    <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]"></div>
                    <div className="relative text-center">
                        <div className="flex justify-center gap-1 mb-2">
                            {[1, 2, 3, 4, 5].map((s) => (
                                <Star key={s} size={14} fill="currentColor" className="text-dark-blue" />
                            ))}
                        </div>
                        <h3 className="text-dark-blue font-black text-2xl tracking-tight uppercase">Limited Partner Offer</h3>
                    </div>
                </div>
                ...
                <div className="p-8 md:p-10 space-y-6">
                    <div className="space-y-2">
                        ...
                        <h2 className="text-2xl md:text-3xl font-bold text-dark-blue dark:text-white leading-tight">
                    ...
                    <div className="bg-light-gray dark:bg-white/5 border border-dark-blue/5 dark:border-white/10 rounded-2xl p-6 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
                                Open a new account via Mesoflix and make a first-time deposit of <span className="text-gold font-bold">$250 or more</span>. Your 3-month TradingView upgrade will be automatically credited.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                        <button
                            ...
                            className="flex-1 bg-dark-blue dark:bg-golden-gradient text-white dark:text-dark-blue py-4 rounded-xl font-bold text-lg hover:shadow-lg transition-all flex items-center justify-center gap-2 transform active:scale-95"
                        >
                            Claim Upgrade Now
                        ...
                        <button
                            onClick={dismiss}
                            className="px-8 py-4 rounded-xl font-bold text-dark-blue dark:text-white border-2 border-dark-blue/10 dark:border-white/10 hover:bg-dark-blue/5 dark:hover:bg-white/5 transition-all"
                        >
                            Maybe Later
                        </button>
                    </div>
