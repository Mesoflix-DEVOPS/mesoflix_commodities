...
const content: Record<string, { title: string; body: React.ReactNode }> = {
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white/5 rounded-xl border border-white/10 p-5">
                    ...
                    <ul className="space-y-2 text-sm text-gray-300">
                        <li className="flex items-start gap-2"><span className="text-teal mt-1">Γ£ô</span> Regulated by top-tier authorities: FCA (UK), ASIC (Australia), CySEC (Cyprus), and NBRB (Belarus).</li>
                        <li className="flex items-start gap-2"><span className="text-teal mt-1">Γ£ô</span> Segregated client funds ΓÇö your money is always kept separate from company funds.</li>
                        <li className="flex items-start gap-2"><span className="text-teal mt-1">Γ£ô</span> AI-powered risk management tools built into the platform.</li>
                        <li className="flex items-start gap-2"><span className="text-teal mt-1">Γ£ô</span> Zero commission on trades ΓÇö revenue comes only from competitive spreads.</li>
                        <li className="flex items-start gap-2"><span className="text-teal mt-1">Γ£ô</span> Named "Best Trading Platform" multiple times by leading financial publications.</li>
                    </ul>
                </div>
                ...
                <div className="bg-teal/5 border border-teal/20 rounded-xl p-4">
                    <p className="text-sm text-gray-300"><span className="font-semibold text-teal">Our Connection:</span> Mesoflix_Pro integrates with Capital.com's API to give you institutional-grade market access, live prices, and the ability to execute real trades on commodities ΓÇö all from within our unified dashboard.</p>
                </div>
            </div>
        ),
    },
        ...
        body: (
            <div className="space-y-6">
                <p className="text-gray-300 leading-relaxed">
                    A <span className="text-teal font-semibold">Contract for Difference (CFD)</span> is a financial agreement between you and a broker to exchange the difference in the price of an asset from when you open a position to when you close it. You never actually own the underlying asset ΓÇö you're simply speculating on whether its price will go up or down.
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-green-500/5 border border-green-500/20 rounded-xl p-5">
                        ...
                        <div className="mt-3 p-3 bg-black/30 rounded-lg text-xs text-gray-400 font-mono">
                            Gold at $2,300 ΓåÆ rises to $2,340<br />
                            Profit = $40 ├ù (lot size)
                        </div>
                    </div>
                    <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-5">
                        ...
                        <div className="mt-3 p-3 bg-black/30 rounded-lg text-xs text-gray-400 font-mono">
                            Gold at $2,300 ΓåÆ drops to $2,260<br />
                            Profit = $40 ├ù (lot size)
                        </div>
                    </div>
                </div>
                <div className="bg-white/5 rounded-xl border border-white/10 p-5">
                    ...
                    <div className="space-y-3 text-sm text-gray-300">
                        ...
                        <div><span className="text-white font-medium">Stop Loss:</span> An order that automatically closes your trade if the price moves against you by a set amount ΓÇö protecting you from large losses.</div>
    ...
    "commodities-overview": {
        ...
        body: (
            <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    {[
                        { name: "Precious Metals", items: ["Gold (XAU/USD)", "Silver (XAG/USD)", "Platinum", "Palladium"], color: "yellow", icon: "≡ƒÑç" },
                        { name: "Energy", items: ["Crude Oil WTI", "Brent Crude", "Natural Gas", "Heating Oil"], color: "orange", icon: "ΓÜí" },
                        { name: "Agriculture", items: ["Wheat", "Corn", "Soybeans", "Cotton"], color: "green", icon: "≡ƒî╛" },
                        { name: "Industrial Metals", items: ["Copper", "Aluminium", "Zinc", "Nickel"], color: "blue", icon: "≡ƒöº" },
                    ].map((cat) => (
                ...
                <div className="bg-white/5 rounded-xl border border-white/10 p-5">
                    ...
                    <ul className="space-y-2 text-sm text-gray-300">
                        <li className="flex items-start gap-2"><span className="text-teal mt-1">Γ£ô</span> <strong className="text-white">Inflation Hedge:</strong> Commodities like gold historically hold value during inflationary periods.</li>
                        <li className="flex items-start gap-2"><span className="text-teal mt-1">Γ£ô</span> <strong className="text-white">Portfolio Diversification:</strong> Low correlation to stocks makes commodities excellent portfolio diversifiers.</li>
                        <li className="flex items-start gap-2"><span className="text-teal mt-1">Γ£ô</span> <strong className="text-white">High Volatility = Opportunity:</strong> Commodity markets react strongly to geopolitical events and economic data.</li>
                        <li className="flex items-start gap-2"><span className="text-teal mt-1">Γ£ô</span> <strong className="text-white">24/5 Trading:</strong> Most commodity markets are tradeable around the clock on weekdays.</li>
                    </ul>
                </div>
            </div>
        ),
    ...
    "gold": {
        title: "Gold (XAU/USD) ΓÇö The Ultimate Safe Haven",
        body: (
            <div className="space-y-6">
                <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4 flex gap-3">
                    <span className="text-2xl">≡ƒÑç</span>
                    <div>
                ...
                <div className="bg-white/5 rounded-xl border border-white/10 p-5 space-y-3">
                    ...
                    <div className="space-y-2 text-sm text-gray-300">
                        <div className="flex gap-2"><span className="text-yellow-400">Γû╕</span> <div><span className="text-white font-medium">US Dollar Strength:</span> Gold and the USD typically move inversely. A weaker dollar = higher gold prices.</div></div>
                        <div className="flex gap-2"><span className="text-yellow-400">Γû╕</span> <div><span className="text-white font-medium">Interest Rates:</span> Higher rates increase opportunity cost of holding gold (no yield), pressing prices down.</div></div>
                        <div className="flex gap-2"><span className="text-yellow-400">Γû╕</span> <div><span className="text-white font-medium">Geopolitical Tension:</span> Wars, political crises, and uncertainty drive investors to gold as a safe haven.</div></div>
                        <div className="flex gap-2"><span className="text-yellow-400">Γû╕</span> <div><span className="text-white font-medium">Inflation Data (CPI/PPI):</span> Higher inflation boosts gold demand as a purchasing power hedge.</div></div>
                        <div className="flex gap-2"><span className="text-yellow-400">Γû╕</span> <div><span className="text-white font-medium">Central Bank Buying:</span> When central banks purchase gold reserves, prices often surge.</div></div>
                    </div>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {[
                        ...
                        { label: "Trading Hours", value: "MonΓÇôFri 24hrs" },
    ...
    "oil": {
        title: "Oil Trading ΓÇö WTI & Brent Crude",
        body: (
            <div className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-orange-500/10 border border-orange-500/20 rounded-xl p-4">
                        <h3 className="font-semibold text-orange-400 mb-2">≡ƒ¢ó∩╕Å WTI (West Texas Intermediate)</h3>
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
                        <h3 className="font-semibold text-blue-400 mb-2">≡ƒîè Brent Crude</h3>
                ...
                <div className="bg-white/5 rounded-xl border border-white/10 p-5 space-y-3">
                    ...
                    <div className="space-y-2 text-sm text-gray-300">
                        <div className="flex gap-2"><span className="text-orange-400">Γû╕</span> <div><span className="text-white font-medium">OPEC+ Decisions:</span> Production cuts or increases by member nations directly impact supply and price.</div></div>
                        <div className="flex gap-2"><span className="text-orange-400">Γû╕</span> <div><span className="text-white font-medium">US Crude Inventories:</span> Weekly EIA report ΓÇö higher inventories suggest oversupply and pressure prices down.</div></div>
                        <div className="flex gap-2"><span className="text-orange-400">Γû╕</span> <div><span className="text-white font-medium">Global Demand:</span> Economic growth, especially from China and India, drives energy demand high.</div></div>
                        <div className="flex gap-2"><span className="text-orange-400">Γû╕</span> <div><span className="text-white font-medium">Geopolitical Events:</span> Middle East conflicts, pipeline disruptions, and sanctions can cause sudden spikes.</div></div>
                        <div className="flex gap-2"><span className="text-orange-400">Γû╕</span> <div><span className="text-white font-medium">USD Strength:</span> Oil is priced in USD ΓÇö a weaker dollar makes oil cheaper for foreign buyers, boosting demand.</div></div>
                    </div>
                </div>
            </div>
        ),
    ...
    "silver": {
        ...
        body: (
            <div className="space-y-6">
                        ...
                        <table className="w-full text-sm text-gray-300">
                            ...
                            <tbody className="divide-y divide-white/5">
                                {[
                                    ...
                                    ["Price Range", "$1,800ΓÇô$2,500+", "$20ΓÇô$35+"],
                                    ["Gold/Silver Ratio", "ΓÇö", "~75ΓÇô90x cheaper"],
                                ].map(([f, g, s]) => (
                                    <tr key={f}>
                ...
                <div className="bg-teal/5 border border-teal/20 rounded-xl p-4">
                    <p className="text-sm text-gray-300"><span className="text-teal font-semibold">Trading Tip:</span> Silver is more volatile than gold, meaning larger price swings ΓÇö both up and down. This creates more opportunity for skilled traders but also more risk.</p>
                </div>
            </div>
        ),
    },
    "natural-gas": {
        title: "Natural Gas ΓÇö Energy's Wild Card",
        body: (
            <div className="space-y-6">
                ...
                <div className="bg-white/5 rounded-xl border border-white/10 p-5 space-y-3">
                    ...
                    <div className="space-y-2 text-sm text-gray-300">
                        <div className="flex gap-2"><span className="text-blue-400">Γû╕</span> <div><span className="text-white font-medium">Weather Forecasts:</span> Cold winters and hot summers spike demand for heating and cooling.</div></div>
                        <div className="flex gap-2"><span className="text-blue-400">Γû╕</span> <div><span className="text-white font-medium">EIA Storage Reports:</span> Weekly inventory data ΓÇö low storage = higher prices.</div></div>
                        <div className="flex gap-2"><span className="text-blue-400">Γû╕</span> <div><span className="text-white font-medium">LNG Export Levels:</span> More exports reduce domestic supply and push prices up.</div></div>
                        <div className="flex gap-2"><span className="text-blue-400">Γû╕</span> <div><span className="text-white font-medium">Geopolitical Events:</span> The Russia-Ukraine war showed how dramatically gas prices can spike on supply concerns.</div></div>
                    </div>
                </div>
                <div className="bg-yellow-500/5 border border-yellow-500/20 rounded-xl p-4 flex gap-3">
                    <AlertTriangle size={16} className="text-yellow-400 flex-shrink-0 mt-0.5" />
                    <p className="text-sm text-gray-300"><span className="text-yellow-400 font-semibold">High Volatility Warning:</span> Natural gas can move 5ΓÇô15% in a single session. Use conservative position sizing and always set stop-loss orders.</p>
                </div>
            </div>
        ),
    },
                    ...
                    {[
                        {
                            ...
                            desc: "Mesoflix_Pro connects to Capital.com via our master trading system. Simply log in ΓÇö your trades will execute through our integrated Capital.com API connection automatically.",
                        },
                        {
                            step: "2",
    ...
    "risk-management": {
        title: "Risk Management ΓÇö Protect Your Capital",
        body: (
            <div className="space-y-6">
                <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 flex gap-3">
                    <Shield size={18} className="text-red-400 flex-shrink-0" />
                    <p className="text-sm text-gray-300">Risk management is not optional ΓÇö it is the single most important discipline for a long-term successful trader. Even experienced professionals suffer losses. The goal is to ensure no single loss can end your trading career.</p>
                </div>
                <div className="grid md:grid-cols-2 gap-4">
                    {[
                        { title: "The 1-2% Rule", icon: "≡ƒÆí", desc: "Never risk more than 1-2% of your total capital on any single trade. This ensures even a string of 10 losses doesn't eliminate your account." },
                        { title: "Always Use Stop Loss", icon: "≡ƒ¢æ", desc: "A stop-loss order automatically exits your trade if the market moves against you beyond your threshold. Always set one before entering a trade." },
                        { title: "Risk/Reward Ratio", icon: "ΓÜû∩╕Å", desc: "Aim for a minimum 1:2 risk/reward ratio ΓÇö risk $1 to potentially gain $2. This means you can be wrong 40% of the time and still be profitable." },
                        { title: "Don't Overtrade", icon: "≡ƒºÿ", desc: "Quality over quantity. Trading too frequently increases transaction costs and emotional decision-making. Wait for high-confidence setups." },
                        { title: "Leverage Caution", icon: "ΓÜá∩╕Å", desc: "Higher leverage means higher risk. While leverage amplifies profit, it equally amplifies losses. New traders should use low leverage (2:1 to 5:1)." },
                        { title: "Diversify", icon: "≡ƒîÉ", desc: "Don't put all your capital into one commodity. Spreading across Gold, Oil, and other instruments reduces correlated risk." },
                    ].map((tip) => (
...
const faqs = [
    {
        ...
        a: "Mesoflix_Pro is an advanced commodity trading intelligence platform that integrates with Capital.com's live market infrastructure. It allows users to trade commodities like Gold, Silver, and Oil, both manually and through automated AI-powered trading engines ΓÇö all from one unified dashboard.",
    },
    {
        q: "Do I need my own Capital.com account?",
        a: "No. Mesoflix_Pro operates through a master trading system integrated with Capital.com's API. You don't need to create your own Capital.com account ΓÇö all trading operations run through our platform seamlessly.",
    },
    {
    ...
    },
    {
        ...
        a: "With the risk controls built into our system ΓÇö including stop-loss orders and maximum drawdown limits on automated engines ΓÇö your losses are capped at predefined levels. However, all trading carries risk and you should only trade with money you can afford to lose.",
    },
    {
    ...
    },
    {
        ...
        a: "Mesoflix_Pro combines institutional-grade Capital.com market access with AI-powered automation, real-time market intelligence, portfolio analytics, and a beautiful, intuitive interface ΓÇö all in one platform. We also provide this educational hub to ensure every user understands what they're trading.",
    },
    {
